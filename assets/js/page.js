...
`
        ...
        buttonHamburguer.innerHTML = `<svg id="sun" xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 24 24">
	...
	<path fill="#f4f8fb" d="M3 18v-2h18v2zm0-5v-2h18v2zm0-5V6h18v2z" />`
        ...
        buttonMode.innerHTML = `  <svg id="moon" xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 24 24">
                        <path d="M0 0h24v24H0z" fill="none" />
                        <path
        ...
        buttonHamburguer.innerHTML = `<svg xmlns="http://www.w3.org/2000/svg" width="2.2rem" height="2.2rem" viewBox="0 0 24 24">
	<path d="M0 0h24v24H0z" fill="none" />
